...
<title>Cat Answer - Member Done</title>
...
try{
	...
	$sql='INSERT INTO member(id,pass,rank,point) VALUES (?,?,?,?)';
	...
	<h2>会員登録の完了</h2>
	<br/>
	<p>次回からは自身のid : <?php print $m_id ?> でログインすることができます。<br/>
	ボタンをクリックするとログインページを表示します。<p>
	<br/>
	<button type="submit" onclick="location.href='login.php'" class="btn">ログインページへ</button>
	<?php
}
catch(Exception $e)
{
	?>
	<h2>申し訳ございません。すでに使われているIDです。</h2>
	<button type="submit" onclick="location.href='m_new.html'" class="btn">会員登録ページへ</button>
	<?php
}
?>
